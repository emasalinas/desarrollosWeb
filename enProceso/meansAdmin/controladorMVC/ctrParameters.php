<?php
/*********************************************************************
* Codigo del archivo	: PHP_021_ctrParameters
* Nombre del archivo	: ctrParameters.php
...
class ctrParameters extends clControlador{
    ...
    public function mPrincipal(){	
		...
		$this->entParameters  					= new entParameters();
		$this->entParameters->vDisplay		 	= 'viewCreate';
