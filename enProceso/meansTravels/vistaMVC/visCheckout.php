    ...
    <div class="row">
      <div class="col-md-12">
        <div class="subheader-info">
          <h1>Confirmá tu viaje</h1>
          <h2>Tiempo restante: <span id="countDown"></span></h2>
        </div>
      </div>
    </div>
  </div>
...
<div class="mt-content" align="center">
  <section class="mt-pagesection" style=" padding: 0px 0px 40px 0px;">
    <div class="container">
      	...
      	<div class="col-md-12">
            ...
            <div class="priceBlock colorOne fl">
              ...
              <div class="priceContent">
                <p class="priceValue"><sup>$</sup> <span><?php echo $this->entCheckout->arrTravel['precioViaje'] ?></span></p>
      ...
      <div id="travelActions"> <a href="./checkout/confirm/posted/" class="btn btn-primary">Checkout</a> </div>
    </div>
  </section>
</div>
...
<script type="text/javascript">
 $(document).ready(function () {
    $('#countDown').countdown({
        until: '+10 sec',
        compact: true,
		onExpiry: fTiempoExpirado,
    });
});

function fTiempoExpirado() { 
	alert('Se ha agotado el tiempo de espera, su asiento se reestablecerá.');
    window.location = './travels/view/<?php echo $this->entCheckout->idTravelEncrypt ?>/renew';
}
</script>